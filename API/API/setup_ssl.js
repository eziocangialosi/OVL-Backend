...
app.listen(80, () => {
  debug.Print('Node.JS SSL Setup server now listening on port 80, please follow the certbot instructions and make sure you can access the server outside your network.');
